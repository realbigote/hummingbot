...
NovadaxOrderBookTrackingDictionary = Dict[Decimal, Dict[str, Dict[str, any]]]

cdef class NovadaxActiveOrderTracker:
    def __init__(self,
                 active_asks: NovadaxOrderBookTrackingDictionary = None,
                 active_bids: NovadaxOrderBookTrackingDictionary = None):
        super().__init__()
    ...
    @property
    def active_asks(self) -> NovadaxOrderBookTrackingDictionary:
        return self._active_asks

    @property
    def active_bids(self) -> NovadaxOrderBookTrackingDictionary:
    ...
    cdef np.ndarray[np.float64_t, ndim=1] c_convert_trade_message_to_np_arrays(self, object message):
        cdef:
