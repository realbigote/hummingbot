...
class NovadaxOrderBookTrackerUnitTest(unittest.TestCase):
    order_book_tracker: Optional[NovadaxOrderBookTracker] = None
    ...
    def setUpClass(cls):
        ...
        cls.order_book_tracker: NovadaxOrderBookTracker = NovadaxOrderBookTracker(
    ...
    def test_order_book_trade_event_emission(self):
        ...
        for ob_trade_event in self.event_logger.event_log:
            ...
            # novadax datetime is in epoch milliseconds
    ...
    def test_tracker_integrity(self):
        ...
        ltcbtc_book: OrderBook = order_books["BTC_USDT"]

        self.assertGreaterEqual(ltcbtc_book.get_price_for_volume(True, 1).result_price,
                                ltcbtc_book.get_price(True))
        self.assertLessEqual(ltcbtc_book.get_price_for_volume(False, 1).result_price,
